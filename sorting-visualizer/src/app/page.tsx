...
import { SortCard } from "@/components/input/SortCard";
...
export default function Home() {
  ...
  const {arrayToSort, isSorting, animationSpeed, setAnimationSpeed, selectedAlgorithm, setSelectedAlgorithm, requireReset, resetArrayAndAnimation, runAnimation } = useSortingAlgorithmContext();
          ...
          <div className="h-[66px] relative flex items-center justify-between w-full">
            ...
            <div className="flex items-center justify-center gap-4">
              ...
              <Select 
                ...
                isDisabled={isSorting}
              />
              <button className="flex items-center justify-center" onClick={handlePlay}>{requireReset ? (
            ...
            <SortCard selectedAlgorithm={selectedAlgorithm}/>
